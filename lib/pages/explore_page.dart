...
class _ExploreState extends State<Explore> {
  ...
  Widget _buildTabContent() {
    switch (_selectedTab) {
      case "Livros":
  return StoreConnector<AppState, Map<String, List<Map<String, dynamic>>>>(
        ...
        child: Column(
          ...
          children: [
            ...
            StoreConnector<AppState, List<Map<String, dynamic>>>(
              converter: (store) => store.state.booksState.weeklyRecommendations,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        book['bookName'] ?? 'Título desconhecido',
                                        maxLines: 1,
