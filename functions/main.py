...
def recommendLibraryBooks(req: https_fn.CallableRequest) -> dict:
    ...
    [
        ...
        {"bookId": "elisabeth-elliot-deixe-me-ser-mulher", "title": "Deixe-me Ser Mulher", "author": "Elisabeth Elliot", "description": "Escrito de mãe para filha no auge do movimento feminista em 1976, este livro reúne ensinamentos preciosos para os dias de hoje sobre o que é ser uma mulher cristã. Com o objetivo de responder à pergunta “O que significa ser mulher”, Elisabeth Elliot aborda vários assuntos relevantes como: submissão, orgulho, liberdade, vocação."},
        {"bookId": "elisabeth-elliot-esperanca-na-solidao-encontrando-deus-na-escuridao", "title": "Esperança na Solidão: Encontrando Deus na Escuridão", "author": "Elisabeth Elliot", "description": "Neste livro, Elisabeth Elliot explora o tema da solidão e como encontrar esperança e a presença de Deus em meio a ela. A autora compartilha reflexões e experiências pessoais para encorajar aqueles que se sentem sozinhos, mostrando que a solidão pode ser um caminho para um relacionamento mais profundo com Deus."},
        {"bookId": "elisabeth-elliot-o-sofrimento-nunca-e-em-vao", "title": "O Sofrimento Nunca é em Vão", "author": "Elisabeth Elliot", "description": "A partir de seu testemunho de vida e todas as provações que ela passou, somos desafiados, encorajados e inspirados a continuar confiando em Deus mesmo nos momentos mais difíceis e angustiantes de nossas vidas."},
        {"bookId": "elisabeth-elliot-uma-vida-de-obediencia-7-disciplinas-para-uma-vida-mais-forte", "title": "Uma Vida de Obediência: 7 Disciplinas para uma Vida mais Forte", "author": "Elisabeth Elliot", "description": "Elisabeth Elliot apresenta sete disciplinas espirituais para fortalecer a vida cristã. Com base em sua própria jornada de fé, a autora explora a importância da obediência a Deus em áreas como a vontade, o corpo, a mente, as posses, o tempo, o trabalho e os sentimentos. O livro oferece um guia prático para uma vida de maior disciplina e dedicação a Deus."},
        ...
        {"bookId": "jen-wilkin-mulheres-da-palavra-como-estudar-a-biblia-com-o-coracao-e-a-mente", "title": "Mulheres da Palavra", "author": "Jen Wilkin", "description": "Oferecendo um plano claro e conciso de aprofundamento no estudo das Sagradas Escrituras, este livro irá ajudar as mulheres a perseverarem na leitura da Palavra de Deus, de forma a treinar suas mentes e transformar seus corações."},
        ...
        {"bookId": "nancy-demoss-adornada-vivendo-a-beleza-do-evangelho-em-meio-as-mulheres", "title": "Adornada: Vivendo a Beleza do Evangelho em Meio às Mulheres", "author": "Nancy DeMoss Wolgemuth", "description": "Nancy DeMoss Wolgemuth explora a passagem de Tito 2 e o chamado para que as mulheres mais velhas ensinem as mais novas. O livro oferece uma visão prática de como viver o evangelho de forma bela e intencional, construindo relacionamentos de mentoria que edificam a igreja e glorificam a Deus."},
