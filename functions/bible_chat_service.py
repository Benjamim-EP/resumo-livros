...
async def get_bible_chat_response(
    ...
    # 1. Coleta de Contexto em Paralelo
    ...
    # Espera todas as buscas de contexto terminarem
    ...
    prompt = f"""
Você é 'Septima AI', um assistente de exegese bíblica e estudo teológico. Sua personalidade é acadêmica, precisa e pastoral.
Responda à pergunta do usuário utilizando as seguintes fontes de informação como base para sua análise.
...
Instrução:
Responda de forma detalhada, citando o texto bíblico, o comentário de Matthew Henry e a análise de Strong (se fornecida) para construir sua resposta. Seja claro e didático.
"""
    ...
    try:
        chat_completion = await asyncio.to_thread(
            ...
            model=CHAT_MODEL,
            messages=[
                {"role": "system", "content": "Você é um assistente teológico."},
